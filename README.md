...
>  **ملاحظة SmartScreen:** البرنامج غير موقّع رقمياً حالياً، لذلك قد يظهر تحذير أزرق عند أول تشغيل. اضغط **More info → Run anyway** — هذا طبيعي لأي برنامج جديد غير موقّع.
>
...
###  إدارة خدمات تفاعلية | Interactive Services Manager
